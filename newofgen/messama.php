...
<div class="container">
	...
	<div class="sidebar">
		...
		<a href="messama.html" class="active">
...
<div class="wrapper">
	...
	<section class="userss">
		<header>
			<div class="content">
				<img src="malik.jpg" alt="">
				<div class="details">
					<span>Malik Hakim</span>
					<p>Active now</p>
				</div>
			</div>
		</header>
		...
		<div class="userss-list">
			<a href="">
				<div class="content">
					...
					<div class="details">
					<span>Kira Lone</span>
					<p>Mister Arthur has scheduled a meeting with you</p>
				</div>
				</div>
			...
			<a href="">
				<div class="content">
					...
					<p>Don't Forget we have a reservation with our investors</p>
				</div>
				</div>
				<div class="status-dot"><i class="fas fa-circle"></i></div>
			</a>
			<a href="">
				<div class="content">
					...
					<p>Boss can I have next week off?</p>
				</div>
				</div>
				<div class="status-dot"><i class="fas fa-circle"></i></div>
			</a>
			<a href="">
				<div class="content">
					<img src="liam.jpg" alt="">
					<div class="details">
					<span>Ling Xue</span>
					<p>Sir it seems the deal with mister Stuart has broken down.</p>
				</div>
				</div>
				<div class="status-dot"><i class="fas fa-circle"></i></div>
			</a>
			<a href="">
				<div class="content">
					...
					<div class="details">
					<span>Husna Yusuf</span>
					<p>Boss I believe I'm more than qualified for a raise.</p>
				</div>
				</div>
				<div class="status-dot"><i class="fas fa-circle"></i></div>
			</a>
			<a href="">
				<div class="content">
					...
					<p>Sir I landed a new investor.</p>
				</div>
				</div>
				<div class="status-dot"><i class="fas fa-circle"></i></div>
			</a>
